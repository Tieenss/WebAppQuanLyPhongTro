  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
        ...
        <Link href="/login" className="bg-slate-50 hover:bg-slate-100 transition-colors p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center justify-center gap-3 group">
